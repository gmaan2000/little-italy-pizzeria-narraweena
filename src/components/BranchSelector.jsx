        ...
        <div className="min-h-screen relative overflow-hidden flex flex-col">
            ...
            <div className="relative z-10 flex flex-col md:flex-row flex-1 min-h-0">
                ...
                >
                    ...
                    {/* Logo watermark */}
                    <img src="/assets/logo-modernized.png" alt="" className="absolute top-6 left-6 w-28 h-28 object-contain opacity-[0.06] pointer-events-none select-none -rotate-12 rounded-full" />
                ...
                >
                    ...
                    {/* Logo watermark */}
                    <img src="/assets/logo-modernized.png" alt="" className="absolute bottom-8 right-8 w-32 h-32 object-contain opacity-[0.05] pointer-events-none select-none rotate-6 rounded-full" />
